...
public class GradingSystem {
  ...
  public String retakeMessage(int percentage, boolean allowedToRetake) {
    if(percentage <= 60 && allowedToRetake == true){
      String string = "The student has been entered for a retake.";
      return string;
    }
    else if(percentage <= 60 && allowedToRetake == false){
      String string = "The student is not allowed to retake this exam.";
      return string;
    }
    else if(percentage >= 60){
      String string = "A retake is not required.";
      return string;
    }
